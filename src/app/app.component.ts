    ...
    <div class="wrapper">
      ...
      <ul nz-menu nzMode="inline" nzTheme="dark" [nzInlineCollapsed]="isCollapsed">
        ...
        <li nz-submenu nzTitle="Navigation Two" nzIcon="appstore">
          <ul>
            <li nz-menu-item (click)="msg(5)">Option 5</li>
            <li nz-menu-item (click)="msg(6)">Option 6</li>
            <li nz-submenu nzTitle="Submenu">
              <ul>
                <li nz-menu-item (click)="msg(7)">Option 7</li>
                <li nz-menu-item (click)="msg(8)">Option 8</li>
              </ul>
            </li>
          </ul>
        </li>
